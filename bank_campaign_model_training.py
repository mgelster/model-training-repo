...
bucket = storage_client.bucket("sid_ml_ops")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "storied-mantra-426123-h6.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://sid_ml_ops/bank_campaign_data/bank-additional.csv"
    model_name='xgboost'
